...
takeStrict z = TL.toStrict . TL.take z
...
byteRange z = if B.null z then 0 else B.maximum z - B.minimum z
...
countUtf8Chars z = case decodeUtf8' z of
  Left _ -> Nothing
...
pingpong z = BL.cycle $ BL.fromStrict z <> BL.reverse (BL.fromStrict z)
